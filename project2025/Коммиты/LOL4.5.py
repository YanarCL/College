...
PADDLE_SPEED = 10  # Скорость движения бит
BALL_SPEED_X = 10  # Горизонтальная скорость шайбы
BALL_SPEED_Y = 10  # Вертикальная скорость шайбы
