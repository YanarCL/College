...
def change_image():
    ...
    if new_photo:
        ...
        exit_btn.place(relx=0.5, rely=0.85, anchor='center')  # Размещаем кнопку выхода под остальными
    else:
...
def open_tutorial():
    ...
    tutorial_window.geometry('400x300')  # Фиксированный размер окна обучения
...
# Кнопка "Выход" для других экранов
exit_btn = Button(root, text='Выход', width=35, height=2, bg='#080675', fg='#AFD7FF', font=('impact', 20, 'bold'), command=exit_game)
